...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-lambda", "1.19.0", __name__, "aws-lambda@1.19.0.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/aws-lambda.AliasProps", jsii_struct_bases=[], name_mapping={'alias_name': 'aliasName', 'version': 'version', 'additional_versions': 'additionalVersions', 'description': 'description', 'provisioned_concurrent_executions': 'provisionedConcurrentExecutions'})
class AliasProps():
    def __init__(self, *, alias_name: str, version: "IVersion", additional_versions: typing.Optional[typing.List["VersionWeight"]]=None, description: typing.Optional[str]=None, provisioned_concurrent_executions: typing.Optional[jsii.Number]=None):
...
class Function(FunctionBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda.Function"):
    ...
    def add_version(self, name: str, code_sha256: typing.Optional[str]=None, description: typing.Optional[str]=None, provisioned_executions: typing.Optional[jsii.Number]=None) -> "Version":
        ...
        """
        return jsii.invoke(self, "addVersion", [name, code_sha256, description, provisioned_executions])
...
class Alias(QualifiedFunctionBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda.Alias"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, alias_name: str, version: "IVersion", additional_versions: typing.Optional[typing.List["VersionWeight"]]=None, description: typing.Optional[str]=None, provisioned_concurrent_executions: typing.Optional[jsii.Number]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param alias_name: Name of this alias.
        ...
        :param provisioned_concurrent_executions: Specifies a provisioned concurrency configuration for a function's alias. Default: No provisioned concurrency
        """
        props = AliasProps(alias_name=alias_name, version=version, additional_versions=additional_versions, description=description, provisioned_concurrent_executions=provisioned_concurrent_executions)
...
class Version(QualifiedFunctionBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-lambda.Version"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, lambda_: "IFunction", code_sha256: typing.Optional[str]=None, description: typing.Optional[str]=None, provisioned_concurrent_executions: typing.Optional[jsii.Number]=None) -> None:
        """
        :param scope: -
        :param id: -
        ...
        """
        props = VersionProps(lambda_=lambda_, code_sha256=code_sha256, description=description, provisioned_concurrent_executions=provisioned_concurrent_executions)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-lambda.VersionProps", jsii_struct_bases=[], name_mapping={'lambda_': 'lambda', 'code_sha256': 'codeSha256', 'description': 'description', 'provisioned_concurrent_executions': 'provisionedConcurrentExecutions'})
class VersionProps():
    def __init__(self, *, lambda_: "IFunction", code_sha256: typing.Optional[str]=None, description: typing.Optional[str]=None, provisioned_concurrent_executions: typing.Optional[jsii.Number]=None):
